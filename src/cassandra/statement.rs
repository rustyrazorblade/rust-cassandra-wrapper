...
pub struct CassStatement {
  pub cass_statement:cass_internal_api::CassStatement
}
...
impl CassStatement {
  ...
  pub fn free(&mut self) {unsafe{
    cass_internal_api::cass_statement_free(&mut(*self).cass_statement)
    }}

  pub fn bind_null(&mut self, index: cass_size_t) -> CassError {unsafe{
    cass_internal_api::cass_statement_bind_null(&mut (*self).cass_statement,index)
  }}

  pub fn bind_int32(&mut self, index: cass_size_t, value: cass_int32_t) -> CassError {unsafe{
    cass_internal_api::cass_statement_bind_int32(&mut(*self).cass_statement,index,value)
  }}

  pub fn bind_int64(&mut self, index: cass_size_t, value: cass_int64_t) -> CassError {unsafe{
    cass_internal_api::cass_statement_bind_int64(&mut(*self).cass_statement,index,value)
  }}

  pub fn bind_float(&mut self, index: cass_size_t, value: cass_float_t) -> CassError {unsafe{
    cass_internal_api::cass_statement_bind_float(&mut(*self).cass_statement,index,value)
  }}

  pub fn bind_double(&mut self, index: cass_size_t, value: cass_double_t) -> CassError {unsafe{
    cass_internal_api::cass_statement_bind_double(&mut(*self).cass_statement,index,value)
  }}

  pub fn _bind_bool(&mut self, index: cass_size_t, value: cass_bool_t) -> CassError {unsafe{
    cass_internal_api::cass_statement_bind_bool(&mut(*self).cass_statement,index,value)
  }}

  pub fn bind_string(&mut self, index: cass_size_t, value: CassString) -> CassError {unsafe{
    cass_internal_api::cass_statement_bind_string(&mut(*self).cass_statement,index,value)
  }}

  pub fn bind_bytes(&mut self, index: cass_size_t, value: CassBytes) -> CassError {unsafe{
    cass_internal_api::cass_statement_bind_bytes(&mut(*self).cass_statement,index,value)
  }}

  pub fn bind_uuid(&mut self, index: cass_size_t, value: CassUuid) -> CassError {unsafe{
    cass_internal_api::cass_statement_bind_uuid(&mut(*self).cass_statement,index,value)
  }}

  pub fn bind_inet(&mut self, index: cass_size_t, value: CassInet) -> CassError {unsafe{
    cass_internal_api::cass_statement_bind_inet(&mut(*self).cass_statement,index,value)
  }}

  pub fn bind_decimal(&mut self, index: cass_size_t, value: CassDecimal) -> CassError {unsafe{
    cass_internal_api::cass_statement_bind_decimal(&mut(*self).cass_statement,index,value)
  }}

  pub fn bind_custom(&mut self, index: cass_size_t, size: cass_size_t, output: *mut *mut cass_byte_t) -> CassError {unsafe{
    cass_internal_api::cass_statement_bind_custom(&mut(*self).cass_statement,index,size,output)
  }}

  pub fn bind_collection(&mut self, index: cass_size_t, collection: *const CassCollection, is_map: cass_bool_t) -> CassError {unsafe{
    cass_internal_api::cass_statement_bind_collection(&mut(*self).cass_statement,index,collection, is_map)
  }}
}
